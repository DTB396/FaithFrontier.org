...
For questions, contact **info@tillerstead.com**. See [`CONTENT_LICENSE.md`]({% link CONTENT_LICENSE.md %}) for creative-work restrictions and [`LICENSE`]({% link LICENSE %}) for code-specific terms.
